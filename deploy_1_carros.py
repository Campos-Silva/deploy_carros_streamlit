...
if pagina == 'Detecção de Fraudadores de Seguro':
    ...
    st.image('https://raw.githubusercontent.com/Campos-Silva/custos_seguro/main/imagem_5.png', width=400)

    st.markdown('Construí esse modelo preditivo para ajudar Agências de Seguro de Saúde a detectarem clientes que estejam possivelmente fraudando informações e assim, obtendo valor de seguro abaixo da tabela de preços relacionado as suas verdadeiras características. Isso pode acarretar graves prejuízos econômicos a seguradora')
